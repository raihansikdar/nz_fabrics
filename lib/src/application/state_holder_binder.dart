...
class StateHolderBinders extends Bindings{
  ...
  void dependencies() {
   ...
   ///  Get.put(SourceWaterController());
     ...
     Get.put(WaterFilterSpecificNodeDataController());
...
//--------------------------- PF History ---------------------------
     ...
     Get.put(ElectricityLongSLDGetAllInfoUIControllers());
     Get.put(ElectricityLongSLDFilterBusBarEnergyCostController());
     Get.put(ElectricityLongBusBarStatusInfoController());
   ...
   /* ->>--------> Short SLD <--------<<- */
     ...
     Get.put(ElectricityShortSLDGetAllInfoUIControllers());
     ...
     Get.put(WaterLongSLDGetAllInfoUIControllers());
   ...
   /* ->>--------------------------> Steam SLD <---------------------------<<- */
   Get.put(SteamLongSLDFilterBusBarEnergyCostController());
