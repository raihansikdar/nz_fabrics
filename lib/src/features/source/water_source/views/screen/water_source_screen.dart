...
import 'package:nz_fabrics/src/features/source/water_source/views/widgets/sub_part/water_live_data_container_widget.dart';
...
import '../widgets/sub_part/yearly_water_chart_widget.dart';
                   ...
                   GetBuilder<OverAllWaterSourceDataController>(
                       builder: (controller) {
                         return Container(
                             ...
                             child: controller.graphType == "Line-Chart" ? OverAllLineWaterChartDataWidget(
                                 lineChartModel:controller.lineChartModel
                             ) :  controller.graphType == "Monthly-Bar-Chart" ? WaterOverAllMonthlyBarChartWidget(
                         ...
                         return Container(
                           ...
                           child: Column(
                             children: [
                               ...
                               LineWaterChartWidget(size: size) : controller.graphType == "Monthly-Bar-Chart" ? MonthlyWaterChartWidget(size: size) : YearlyEnergyChartWidget(size: size)
                             ],
                           ),
                         );
                       }
                     ...
                     child: Column(
                       children: [
                         ...
                         GetBuilder<WaterSourceCategoryWiseLiveDataController>(
                           builder: (controller) {
                             // Find data for Sub_Mersible, defaulting to zero values if not found
                             ...
                             // Find data for WTP, defaulting to zero values if not found
