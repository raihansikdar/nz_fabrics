  ...
  Widget build(BuildContext context) {
    return GetBuilder<OverAllSourceDataController>(
      builder: (controller) {
        ...
        //   ChartData('Grid', percentages.grid?.toDouble() ?? 0.0, ui.Gradient.linear(
        //     const Offset(0, 0),
        //     const Offset(1, 1),
        //     [const Color(0xFFFFA500), const Color(0xFFFF7F00)],
        //   ),),
        //   ChartData('Solar', percentages.solar?.toDouble() ?? 0.0, ui.Gradient.linear(
        //     const Offset(0, 0),
        //     const Offset(1, 1),
        //     [const Color(0xFF66D6FF), const Color(0xFF4FA3CC)],
        //   ),),
        //   ChartData('Diesel Generator', percentages.dieselGenerator?.toDouble() ?? 0.0, ui.Gradient.linear(
        //     const Offset(0, 0),
        //     const Offset(1, 1),
        //     [const Color(0xFF00008B), const Color(0xFF4B0082)],
        //   ),),
        // ];
