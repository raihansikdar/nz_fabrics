...
class NotDoneWorkWidget extends StatelessWidget {
  const NotDoneWorkWidget({
    super.key,
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: size.height * k10TextSize ,),
                      const TextComponent(text: "Reason",color: AppColors.secondaryTextColor,),
                    ],
                  ),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          const TextComponent(text: "Not Done",color: Colors.red),
                        ],
                      ),
                      SizedBox(height: size.height * k10TextSize ,),
                      TextComponent(text: chartData.shedName ?? '',color: AppColors.primaryTextColor,),
                      SizedBox(height: size.height * k10TextSize ,),
                      TextComponent(text: chartData.reason ?? '',color: AppColors.primaryTextColor,),
