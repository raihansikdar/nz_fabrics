...
class UserManagementBoxWidget extends StatelessWidget {
  const UserManagementBoxWidget({
    super.key,
    required this.size, required this.firstText, required this.secondText, required this.firstSvgPicture, required this.boxColor, required this.textColor,
  });
