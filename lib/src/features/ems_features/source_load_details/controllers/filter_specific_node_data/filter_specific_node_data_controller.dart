...
class FilterSpecificNodeDataController extends GetxController with InternetConnectivityCheckMixin{
  ...
  Future<bool> fetchFilterSpecificTableData({required String nodeName,required String fromDate, required String toDate ,bool fromButton = false}) async {
    ...
    try {
      ...
      //
      // log("getFilterSSpecificTableDataUrl statusCode ==> ${response.statusCode}");
