...
class WaterGaugeWidget extends StatefulWidget {
  final double gaugeValue;
  final double gaugeMaxValue;
  const WaterGaugeWidget({super.key, required this.gaugeValue, required this.gaugeMaxValue});

  @override
  WaterGaugeWidgetState createState() => WaterGaugeWidgetState();
}

class WaterGaugeWidgetState extends State<WaterGaugeWidget> {
