...
class WaterDailyLineChartWidget extends StatelessWidget {
   ...
   const  WaterDailyLineChartWidget({super.key, required this.elementName, this.dailyDataList,this.waterDailyDataList ,required this.screenName, required this.viewName, this.naturalGasDailyDataList,  this.machineMaxPowerModel });
