...
class WaterYearlyBarChartWidget extends StatelessWidget {
  ...
  const WaterYearlyBarChartWidget({super.key, required this.elementName, required this.screenName,  this.yearlyDataModelList, required this.viewName,  this.waterYearlyDataModelList, this.naturalGasYearlyDataModelList});
