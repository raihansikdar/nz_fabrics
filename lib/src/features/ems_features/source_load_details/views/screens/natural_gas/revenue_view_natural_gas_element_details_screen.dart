...
class RevenueViewNaturalGasElementDetailsScreen extends StatefulWidget {
  final String elementName;
  final String elementCategory;
  const RevenueViewNaturalGasElementDetailsScreen({super.key, required this.elementName, required this.elementCategory});

  @override
  State<RevenueViewNaturalGasElementDetailsScreen> createState() => _RevenueViewNaturalGasElementDetailsScreenState();
}

class _RevenueViewNaturalGasElementDetailsScreenState extends State<RevenueViewNaturalGasElementDetailsScreen> with  TickerProviderStateMixin {
              ...
              child: Column(
                children: [
                  ...
                  RunTimeInformationWidget(
                    ...
                    thisDay: Get.find<NaturalGasThisDayDataController>().thisDayData.thisDayCostGas ?? 0.00,
                    thisMonth: Get.find<NaturalGasThisMonthDataController>().thisMonthData.isNotEmpty ? Get.find<NaturalGasThisMonthDataController>().thisMonthData[0].cost ?? 0.00 : 0.00,
                    thisYear: Get.find<NaturalGasThisYearDataController>().thisYearData.cost ?? 0.00,
                  ),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    Expanded(child: TextComponent(text: "Today ${widget.elementName} Gas Cost (BDT)",fontWeight: FontWeight.w600,overflow: TextOverflow.ellipsis,maxLines: 1,)),
                                  ],
                                ),
                                Positioned(
                                  right: 0,
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: size.width * k20TextSize,),
                                    Expanded(child: TextComponent(text: "This month ${widget.elementName} Gas Cost",fontWeight: FontWeight.w600,overflow: TextOverflow.ellipsis,maxLines: 1,)),
                                  ],
                                ),
                                Positioned(
                                  right: 0,
                            ...
                            children: [
                              ...
                              GetBuilder<NaturalGasMonthlyDataController>(
                                  builder: (naturalGasMonthlyDataController) {
                                    ...
                                    return SizedBox(
                                        height: size.height * .28,
                                        child: MonthlyDetailsBarChartWidget(elementName: widget.elementName,solarCategory: 'Natural Gas',viewName: 'revenueView',naturalGasMonthlyDataModel:naturalGasMonthlyDataController.monthlyDataList, screenName: 'naturalGasScreen',));
                                  }
                              ),
                              SizedBox(height: size.height * k20TextSize),
                            ],
                            ...
                            children: [
                              ...
                              GetBuilder<NaturalGasYearlyDataController>(
                                  builder: (naturalGasYearlyDataController) {
                                    ...
                                    return SizedBox(
                                        height: size.height * .28,
                                        child: YearlyBarChartWidget(elementName: widget.elementName,screenName: 'naturalGasScreen', naturalGasYearlyDataModelList: naturalGasYearlyDataController.yearlyDataList, viewName: 'revenueView',));
                                  }
                              ),
                              SizedBox(height: size.height * k20TextSize),
                            ],
