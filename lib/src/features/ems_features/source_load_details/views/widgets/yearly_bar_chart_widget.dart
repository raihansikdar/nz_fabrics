// import 'package:nz_ums/src/features/ems_features/source_load_details/models/natural_gas/natural_gas_yearly_data_model.dart';
// import 'package:nz_ums/src/features/ems_features/source_load_details/models/power_and_energy/yearly_data_model.dart';
// import 'package:nz_ums/src/features/ems_features/source_load_details/models/water/water_yearly_data_model.dart';
...
//         waterChartItem.instantCost = data.instantCost ?? 0.0;
//       }
//     });
//
...
//                 labelStyle: TextStyle(fontSize: size.height * k13TextSize, color: AppColors.primaryTextColor),
//               ),
...
//                 ColumnSeries<WaterChartData, String>(
//                   color: AppColors.primaryColor,
//                   dataSource: waterChartData, // Updated chart data
//                   xValueMapper: (WaterChartData data, _) => data.month,
...
//             ColumnSeries<ChartData, String>(
//             color: AppColors.primaryColor,
//             dataSource: chartData, // Updated chart data
//                 xValueMapper: (ChartData data, _) => data.month,
