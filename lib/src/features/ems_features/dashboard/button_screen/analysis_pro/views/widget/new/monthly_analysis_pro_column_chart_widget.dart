...
class AnalysisProMonthlyColumnChartWidget extends StatelessWidget {
  final List<MonthlyDataModel> monthlySourceData;
  final List<MonthlyDataModel> monthlyLoadData;
  final ElectricityDayAnalysisProController controller;

  const AnalysisProMonthlyColumnChartWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: SizedBox(
        width: controller.dateDifference > 15 ? 2500 : 1500,
        child: Padding(
