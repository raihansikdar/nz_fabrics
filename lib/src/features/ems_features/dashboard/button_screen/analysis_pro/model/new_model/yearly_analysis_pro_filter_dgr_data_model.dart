class YearlyAnalysisProFilterDgrDataModel {
  String? graphType;
  List<YearlyDataModel>? data;

  YearlyAnalysisProFilterDgrDataModel({this.graphType, this.data});

  YearlyAnalysisProFilterDgrDataModel.fromJson(Map<String, dynamic> json) {
    graphType = json['graph-type'];
    if (json['data'] != null) {
      data = <YearlyDataModel>[];
      json['data'].forEach((v) {
        data!.add(YearlyDataModel.fromJson(v));
      });
    }
  }
