...
class GasGeneratorDateWidget extends StatefulWidget {
  const GasGeneratorDateWidget({super.key});

  @override
  State<GasGeneratorDateWidget> createState() => _DateWidgetState();
}

class _DateWidgetState extends State<GasGeneratorDateWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        GetBuilder<DailyGasGeneratorButtonController>(
                          ...
                          child: dailyGasButtonController.selectedButton == 1
                            ...
                            children: [
                              Row( mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  GetBuilder<MonthlyGasGeneratorButtonController>(
                              ...
                              SizedBox(
                                ...
                                child: GetBuilder<MonthlyGasGeneratorButtonController>(
                                    builder: (monthlyGasButtonController) {
                                      return ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await monthlyGasButtonController.fetchMonthlyGasGeneratorData(selectedMonth: selectedMonth.toString(), selectedYear: selectedYear.toString());
                            ...
                            children: [
                              ...
                              GetBuilder<YearlyGasGeneratorButtonController>(
                              ...
                              SizedBox(
                                ...
                                width: size.width * 0.4,
                                child: GetBuilder<YearlyGasGeneratorButtonController>(
                                    builder: (yearlyGasButtonController) {
                                      return ElevatedButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            await yearlyGasButtonController.fetchYearlyGasGeneratorData(selectedYearDate: onlySelectedYear);
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  GetBuilder<CustomGasGeneratorButtonController>(
                              ...
                              SizedBox(
                                height:  size.width * 0.1,
                                width: size.width * 0.4,
                                child: GetBuilder<CustomGasGeneratorButtonController>(
                                    builder: (customGasButtonController) {
                                      return ElevatedButton(

                                          onPressed: () async {
                                            await customGasButtonController.fetchCustomGasGeneratorData(fromDate:  customGasButtonController.fromDateTEController.text, toDate:  customGasButtonController.toDateTEController.text);
