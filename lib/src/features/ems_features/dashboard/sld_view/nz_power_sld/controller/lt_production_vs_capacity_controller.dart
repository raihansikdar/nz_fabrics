...
class LtProductionVsCapacityController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<LtProductionVsCapacityController>()) {
      final controller = Get.find<LtProductionVsCapacityController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<LtProductionVsCapacityController>()) {
      final controller = Get.put(LtProductionVsCapacityController());
