...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/controller/live_pf_data_controller.dart';
...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/model/live_all_node_power_model.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/model/loop_and_bus_cupler_model.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/screens/main_bus_bar_true/screen/main_bus_bar_true_screen.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/nz_box_with_icon_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/nz_circle_with_icon_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/nz_source_and_load_box_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/model/view_page_model.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/bus_couplar_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/line_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/main_bus_bar_2.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/meter_bus_bar_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/nz_tr_box_with_icon_widget.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/nz_power_sld/views/widgets/super_bus_bar_widget.dart';
...
class NZPowerSldScreen extends StatefulWidget {
  const NZPowerSldScreen({super.key});

  @override
  State<NZPowerSldScreen> createState() => _NZPowerSldScreenState();
}

class _NZPowerSldScreenState extends State<NZPowerSldScreen>
  ...
  void initState() {
    ...
    Get.find<LtProductionVsCapacityController>().fetchProductVsCapacityData();
    Get.find<LiveAllNodePowerController>().fetchLiveAllNodePower();
    Get.find<LtProductionVsCapacityController>().startApiCallOnScreenChange();
    Get.find<LiveAllNodePowerController>().startApiCallOnScreenChange();
...
//  final PhotoViewController _photoViewController = PhotoViewController();
  ...
  List<Widget> _buildPFWidgets(double minX, double minY) {
    return _pfData.map((item) {
      var controller = Get.put(LivePfDataController(), tag: item['node_name']);
      controller.fetchLivePFData(nodeName: item['node_name']);

      return GetBuilder<LivePfDataController>(
        tag: item['node_name'],
        builder: (controller) {
          return Positioned(
