...
class SteamLongSLDLiveAllNodePowerController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {


  bool _isConnected = true;
  bool _isLiveAllNodePowerInProgress = false;
  String _errorMessage = '';
  List<SteamLongLiveAllNodePowerModel>  _liveAllNodePowerModel = [];

  bool get isConnected => _isConnected;
  bool get isLiveAllNodePowerInProgress => _isLiveAllNodePowerInProgress;
  String get errorMessage => _errorMessage;
  List<SteamLongLiveAllNodePowerModel>  get liveAllNodePowerModel => _liveAllNodePowerModel;
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<SteamLongSLDLiveAllNodePowerController>()) {
      final controller = Get.find<SteamLongSLDLiveAllNodePowerController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<SteamLongSLDLiveAllNodePowerController>()) {
      final controller = Get.put(SteamLongSLDLiveAllNodePowerController());
    ...
    try {
     ...
     // log("getLiveAllNodePowerUrl body ==> ${response.body}");
      ...
      if (response.isSuccess) {
        ...
        _liveAllNodePowerModel = jsonData.map((json)=> SteamLongLiveAllNodePowerModel.fromJson(json)).toList();
