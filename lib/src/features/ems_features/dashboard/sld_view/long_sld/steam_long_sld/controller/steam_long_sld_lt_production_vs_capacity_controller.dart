...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/long_sld/steam_long_sld/model/steam_long_lt_production_vs_capacity_model.dart';
...
class SteamLongSLDLtProductionVsCapacityController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {


  bool _isConnected = true;
  bool _isLtProductionVsCapacityInProgress = false;
  String _errorMessage = '';
  SteamLongLTProductionVsCapacityModel  _ltProductionVsCapacityModel = SteamLongLTProductionVsCapacityModel ();

  bool get isConnected => _isConnected;
  bool get isLtProductionVsCapacityInProgress => _isLtProductionVsCapacityInProgress;
  String get errorMessage => _errorMessage;
  SteamLongLTProductionVsCapacityModel  get ltProductionVsCapacityModel => _ltProductionVsCapacityModel;
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<SteamLongSLDLtProductionVsCapacityController>()) {
      final controller = Get.find<SteamLongSLDLtProductionVsCapacityController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<SteamLongSLDLtProductionVsCapacityController>()) {
      final controller = Get.put(SteamLongSLDLtProductionVsCapacityController());
  ...
  Future<bool> fetchProductVsCapacityData() async {
    ...
    try {
      ...
      if (response.isSuccess) {
        ...
        _ltProductionVsCapacityModel = SteamLongLTProductionVsCapacityModel.fromJson(jsonData);
