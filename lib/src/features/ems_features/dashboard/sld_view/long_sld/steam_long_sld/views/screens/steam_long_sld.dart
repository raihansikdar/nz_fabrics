...
//       setState(() {
//         _liveData = Map<int, SteamLiveDataModel>.from(json
//             .decode(cachedLiveData)
//             .map((id, data) =>
//             MapEntry(int.parse(id), SteamLiveDataModel.fromJson(data))));
//       });
//     }
//   }
//
...
//
//         if (nodeData != null) {
//           SteamLiveDataModel liveDataModel = SteamLiveDataModel(
...
class SteamLongSldScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWidget(text: "Steam SLD", backPreviousScreen: true,onBackButtonPressed: (){}),
      body: Center(
        child: Text("No Data Available"),
      ),
    );
