...
class SteamLongSLDFilterBusBarEnergyCostController extends GetxController with InternetConnectivityCheckMixin{
  ...
  List<SteamLongFilterBusBarEnergyCostModel> _filterBusBarEnergyBusBarList = <SteamLongFilterBusBarEnergyCostModel>[];
  ...
  List<SteamLongFilterBusBarEnergyCostModel> get filterBusBarEnergyBusBarList => _filterBusBarEnergyBusBarList;
  ...
  Future<bool> fetchFilterSpecificData({required String busBarName,required String fromDate, required String toDate ,bool fromButton = false}) async {
    ...
    try {
      ...
      if (response.isSuccess) {
          ...
          _filterBusBarEnergyBusBarList = jsonData.map((json) => SteamLongFilterBusBarEnergyCostModel.fromJson(json as Map<String, dynamic>)).toList();
