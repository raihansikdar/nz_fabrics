...
class ElectrictylongSuperBusBarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Keep the layout horizontal, no need to swap dimensions
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            // Node name text (rotated if vertical)
            Center(
              child: Transform.rotate(
...
//   final bool sensorStatus;
//   final double value; // Power value to be displayed
//   final String nodeName;
//   final String backgroundColor;
//   final String borderColor;
//   final Color textColor;
...
//     // Normalize orientation for case-insensitive comparison
//     final normalizedOrientation = orientation.toLowerCase();
//     // Keep the layout horizontal, no dimension swapping
//     final effectiveWidth = loadBoxWidth;
//     final effectiveHeight = loadBoxHeight;
//
//     return GestureDetector(
...
//               ],
//             ),
//             // Node name and power value text (rotated if vertical)
//             Center(
//               child: Transform.rotate(
//                 angle: normalizedOrientation == 'vertical' ? -pi / 2 : 0,
//                 alignment: Alignment.center,
