...
class ElectricityLongSLDFilterBusBarEnergyCostController extends GetxController with InternetConnectivityCheckMixin{
  ...
  List<ElectricityLongFilterBusBarEnergyCostModel> _filterBusBarEnergyBusBarList = <ElectricityLongFilterBusBarEnergyCostModel>[];
  ...
  List<ElectricityLongFilterBusBarEnergyCostModel> get filterBusBarEnergyBusBarList => _filterBusBarEnergyBusBarList;
  ...
  Future<bool> fetchFilterSpecificData({required String busBarName,required String fromDate, required String toDate ,bool fromButton = false}) async {
    ...
    try {
      ...
      if (response.isSuccess) {
          ...
          _filterBusBarEnergyBusBarList = jsonData.map((json) => ElectricityLongFilterBusBarEnergyCostModel.fromJson(json as Map<String, dynamic>)).toList();
