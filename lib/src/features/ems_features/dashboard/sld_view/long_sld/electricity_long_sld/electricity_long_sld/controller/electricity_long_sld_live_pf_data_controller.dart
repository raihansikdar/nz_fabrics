...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/long_sld/electricity_long_sld/electricity_long_sld/model/electricity_long_live_pf_data_model.dart';
...
class ElectricityLongSldLivePfDataController extends GetxController with InternetConnectivityCheckMixin {

  bool _isConnected = true;
  bool _isPFHistoryInProgress = false;
  String _errorMessage = '';
  bool _firstPFHistoryInProgress = true;
  ElectricityLongSLDLivePFDataModel _livePFDataModel = ElectricityLongSLDLivePFDataModel();

  bool get isConnected => _isConnected;
  bool get isPFHistoryInProgress => _isPFHistoryInProgress;
  String get errorMessage => _errorMessage;
  ElectricityLongSLDLivePFDataModel get livePFDataModel => _livePFDataModel;
    ...
    try {
     ...
     //  log("getLivePFDataUrl body ==> ${response.body}");
      ...
      if (response.isSuccess) {
        ...
        _livePFDataModel = ElectricityLongSLDLivePFDataModel.fromJson(jsonData);
