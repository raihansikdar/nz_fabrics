...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/long_sld/electricity_long_sld/electricity_long_sld/model/electricity_long_lt_production_vs_capacity_model.dart';
...
class ElectricityLongSLDLtProductionVsCapacityController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {


  bool _isConnected = true;
  bool _isLtProductionVsCapacityInProgress = false;
  String _errorMessage = '';
  ElectrictyLongLTProductionVsCapacityModel  _ltProductionVsCapacityModel = ElectrictyLongLTProductionVsCapacityModel ();

  bool get isConnected => _isConnected;
  bool get isLtProductionVsCapacityInProgress => _isLtProductionVsCapacityInProgress;
  String get errorMessage => _errorMessage;
  ElectrictyLongLTProductionVsCapacityModel  get ltProductionVsCapacityModel => _ltProductionVsCapacityModel;
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<ElectricityLongSLDLtProductionVsCapacityController>()) {
      final controller = Get.find<ElectricityLongSLDLtProductionVsCapacityController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<ElectricityLongSLDLtProductionVsCapacityController>()) {
      final controller = Get.put(ElectricityLongSLDLtProductionVsCapacityController());
  ...
  Future<bool> fetchProductVsCapacityData() async {
    ...
    try {
      ...
      if (response.isSuccess) {
        ...
        _ltProductionVsCapacityModel = ElectrictyLongLTProductionVsCapacityModel.fromJson(jsonData);
