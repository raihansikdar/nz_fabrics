class ElectricityLongLiveDataModels {
  final double power;
  final bool sensorStatus;
  final String sourceType;
  final DateTime? timedate;

  ElectricityLongLiveDataModels({
    required this.power,
  ...
  factory ElectricityLongLiveDataModels.fromJson(Map<String, dynamic> json) {
    return ElectricityLongLiveDataModels(
