...
class ElectricityLongViewPageModel {
  final int id;
  ...
  factory ElectricityLongViewPageModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      return ElectricityLongViewPageModel(
        id: json['id'] as int,
