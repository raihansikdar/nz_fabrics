...
// import 'package:nz_ums/src/features/ems_features/dashboard/sld_view/nz_power_sld/model/main_bus_bar_true_model/electricity_long_filter_bus_bar_const_model.dart';
// import 'package:syncfusion_flutter_charts/charts.dart';
// import 'package:nz_ums/src/utility/style/app_colors.dart';
//
// class FilterBusBarWidget extends StatelessWidget {
//   final List<FilterBusBarEnergyCostModel> monthlyDataList;
//   final Size size;
//   final int dateDifference;
//
//   const FilterBusBarWidget({super.key, required this.size, required this.dateDifference, required this.monthlyDataList});
//
//   @override
...
//         child: SizedBox(
//           width: (dateDifference > 3 && dateDifference< 90) ? 1200 : size.width,
...
//               intervalType: dateDifference > 90 ? DateTimeIntervalType.months : DateTimeIntervalType.days,
//
...
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/long_sld/electricity_long_sld/electricity_long_sld/model/main_bus_bar_true_model/electricity_long_filter_bus_bar_const_model.dart';
import 'package:syncfusion_flutter_charts/charts.dart';
...
class ElectricityLongSLDFilterBusBarWidget extends StatelessWidget {

  final List<ElectricityLongFilterBusBarEnergyCostModel> monthlyDataList;
  final Size size;
  final int dateDifference;

  const ElectricityLongSLDFilterBusBarWidget({super.key, required this.size, required this.dateDifference, required this.monthlyDataList});
