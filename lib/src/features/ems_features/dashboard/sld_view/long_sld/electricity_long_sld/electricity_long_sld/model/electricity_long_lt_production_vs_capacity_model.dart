class ElectrictyLongLTProductionVsCapacityModel {
  ...
  ElectrictyLongLTProductionVsCapacityModel(
  ...
  ElectrictyLongLTProductionVsCapacityModel.fromJson(Map<String, dynamic> json) {
