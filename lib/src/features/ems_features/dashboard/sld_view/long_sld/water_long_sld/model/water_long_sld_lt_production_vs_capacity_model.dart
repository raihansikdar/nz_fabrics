class WaterLongSLDLTProductionVsCapacityModel {
  ...
  WaterLongSLDLTProductionVsCapacityModel(
  ...
  WaterLongSLDLTProductionVsCapacityModel.fromJson(Map<String, dynamic> json) {
