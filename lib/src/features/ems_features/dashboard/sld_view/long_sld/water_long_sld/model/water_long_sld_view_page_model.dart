...
class WaterLongSLDViewPageModel {
  final int id;
  ...
  factory WaterLongSLDViewPageModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      return WaterLongSLDViewPageModel(
        id: json['id'] as int,
