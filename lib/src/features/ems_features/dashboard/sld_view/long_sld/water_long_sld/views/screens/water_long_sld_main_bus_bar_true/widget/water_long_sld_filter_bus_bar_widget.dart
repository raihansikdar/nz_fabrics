...
class WaterLongSLDFilterBusBarWidget extends StatelessWidget {

  final List<FilterBusBarEnergyCostModel> monthlyDataList;
  final Size size;
  final int dateDifference;

  const WaterLongSLDFilterBusBarWidget({super.key, required this.size, required this.dateDifference, required this.monthlyDataList});
