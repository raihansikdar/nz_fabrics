...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/long_sld/water_long_sld/model/water_short_sld_main_bus_bar_true_model/water_long_sld_filter_bus_bar_const_model.dart';
...
class WaterLongSLDFilterBusBarEnergyCostController extends GetxController with InternetConnectivityCheckMixin{
  ...
  List<WaterLongSLDFilterBusBarEnergyCostModel> _filterBusBarEnergyBusBarList = <WaterLongSLDFilterBusBarEnergyCostModel>[];
  ...
  List<WaterLongSLDFilterBusBarEnergyCostModel> get filterBusBarEnergyBusBarList => _filterBusBarEnergyBusBarList;
  ...
  Future<bool> fetchFilterSpecificData({required String busBarName,required String fromDate, required String toDate ,bool fromButton = false}) async {
    ...
    try {
      ...
      if (response.isSuccess) {
          ...
          _filterBusBarEnergyBusBarList = jsonData.map((json) => WaterLongSLDFilterBusBarEnergyCostModel.fromJson(json as Map<String, dynamic>)).toList();
