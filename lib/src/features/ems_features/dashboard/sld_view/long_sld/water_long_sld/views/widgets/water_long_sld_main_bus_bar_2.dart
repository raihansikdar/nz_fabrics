...
import 'dart:math';
import 'package:auto_size_text/auto_size_text.dart'; // Import auto_size_text package

class WaterLongSLDMainBusBarTrue extends StatelessWidget {
  ...
  const WaterLongSLDMainBusBarTrue({
    Key? key,
