...
//     String? cachedViewPageData = prefs.getString('water_long_sld_viewPageData');
//     String? viewPageCacheTime = prefs.getString('water_long_sld_viewPageData_time');
...
//         isCacheValid = true;
//         final List<WaterLongSLDViewPageModel> parsedData = (json.decode(cachedViewPageData) as List)
//             .map((data) => WaterLongSLDViewPageModel.fromJson(data))
//             .toList();
//
//         // Load cached live data
//         String? cachedLiveData = prefs.getString('water_long_sld_liveData');
...
//         'water_long_sld_viewPageData',
//         json.encode(_viewPageData.map((data) => data.toJson()).toList()));
//     await prefs.setString('water_long_sld_viewPageData_time', DateTime.now().toIso8601String());
//     await prefs.setString(
//         'water_long_sld_liveData',
...
//         final newViewPageData = data.map((e) => WaterLongSLDViewPageModel.fromJson(e)).toList();
//
...
//         WaterLongSLDGetAllInfoUIControllers controller = Get.find();
...
//   bool _compareViewPageData(List<WaterLongSLDViewPageModel> oldData, List<WaterLongSLDViewPageModel> newData) {
...
//       WaterLongSLDGetAllInfoUIControllers controller, String parentRequestId) async {
...
//       switch (item.shape) {
//         case 'circle':
//           widget = GetBuilder<WaterLongSLDLiveAllNodePowerController>(
...
//               return WaterLongSLDCircleWithIcon(
...
//                 return GetBuilder<WaterLongSLDLtProductionVsCapacityController>(
...
//                   return WaterLongSLDSourceAndLoadBoxWidget(
//                     sensorStatus: power != 0.0,
//                     value: power,
//                     nodeName: item.nodeName,
//                     borderColor: item.borderColor ?? '#FF0000',
...
//                     color: item.color ?? '#FF0000',
//                     onTap: () {
//                       Get.to(() => WaterLongSLDMainBusBarTrueScreen(busBarName: item.nodeName),
//                         transition: Transition.rightToLeft,
//                         duration: const Duration(seconds: 1),
//                       );
//                     },
...
//                 return WaterLongSLDMeterBusBarWidget(
//                   sensorStatus: power != 0.0,
//                   value: power,
//                   nodeName: item.nodeName,
//                   color: item.color,
...
// }
//
// class WaterLongSLDGetAllInfoUIControllers extends GetxController {
...
class _WaterLongSldScreenState extends State<WaterLongSldScreen>
  ...
  Future<void> _fetchViewPageData() async {
    ...
    try {
      ...
      debugPrint('-----Water Long  ------>>> ${Urls.longWateryUrl}');
              ...
              widget = GetBuilder<WaterLongSLDLiveAllNodePowerController>(
                ...
                builder: (controller) {
                  ...
                  return WaterLongSLDMainBusBarTrue(
                    ...
                    onTap: () {
                      Get.to(
                            () => WaterLongSLDMainBusBarTrueScreen(
                          busBarName: item.nodeName,
                        ),
                        transition: Transition.rightToLeft,
                        duration: const Duration(seconds: 1),
