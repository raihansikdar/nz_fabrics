class SteamShortLTProductionVsCapacityModel {
  ...
  SteamShortLTProductionVsCapacityModel(
  ...
  SteamShortLTProductionVsCapacityModel.fromJson(Map<String, dynamic> json) {
