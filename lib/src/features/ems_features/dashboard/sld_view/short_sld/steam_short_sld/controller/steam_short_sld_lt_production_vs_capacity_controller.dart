...
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/short_sld/steam_short_sld/model/steam_short_lt_production_vs_capacity_model.dart';
import 'package:nz_fabrics/src/features/ems_features/dashboard/sld_view/short_sld/water_short_sld/model/water_short_lt_production_vs_capacity_model.dart';
...
class SteamShortSLDLtProductionVsCapacityController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {


  bool _isConnected = true;
  bool _isLtProductionVsCapacityInProgress = false;
  String _errorMessage = '';
  SteamShortLTProductionVsCapacityModel  _ltProductionVsCapacityModel = SteamShortLTProductionVsCapacityModel ();

  bool get isConnected => _isConnected;
  bool get isLtProductionVsCapacityInProgress => _isLtProductionVsCapacityInProgress;
  String get errorMessage => _errorMessage;
  SteamShortLTProductionVsCapacityModel  get ltProductionVsCapacityModel => _ltProductionVsCapacityModel;
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<SteamShortSLDLtProductionVsCapacityController>()) {
      final controller = Get.find<SteamShortSLDLtProductionVsCapacityController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<SteamShortSLDLtProductionVsCapacityController>()) {
      final controller = Get.put(SteamShortSLDLtProductionVsCapacityController());
  ...
  Future<bool> fetchProductVsCapacityData() async {
    ...
    try {
      ...
      if (response.isSuccess) {
        ...
        _ltProductionVsCapacityModel = SteamShortLTProductionVsCapacityModel.fromJson(jsonData);
