...
class SteamShortSLDFilterBusBarEnergyCostController extends GetxController with InternetConnectivityCheckMixin{
  ...
  List<SteamShortFilterBusBarEnergyCostModel> _filterBusBarEnergyBusBarList = <SteamShortFilterBusBarEnergyCostModel>[];
  ...
  List<SteamShortFilterBusBarEnergyCostModel> get filterBusBarEnergyBusBarList => _filterBusBarEnergyBusBarList;
  ...
  Future<bool> fetchFilterSpecificData({required String busBarName,required String fromDate, required String toDate ,bool fromButton = false}) async {
    ...
    try {
      ...
      if (response.isSuccess) {
          ...
          _filterBusBarEnergyBusBarList = jsonData.map((json) => SteamShortFilterBusBarEnergyCostModel.fromJson(json as Map<String, dynamic>)).toList();
