class ElectricityShortLoopAndBusCouplerModel {
  String? timedate;
  dynamic powerMeter;
  String? node;
  List<Lines>? lines;
  ...
  ElectricityShortLoopAndBusCouplerModel(
      {this.timedate, this.powerMeter, this.node, this.lines, this.sourceType});

  ElectricityShortLoopAndBusCouplerModel.fromJson(Map<String, dynamic> json) {
