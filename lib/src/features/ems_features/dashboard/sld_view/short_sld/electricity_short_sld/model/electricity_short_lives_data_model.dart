class ElectricityShortLiveDataModels {
  final double power;
  final bool sensorStatus;
  final String sourceType;
  final DateTime? timedate;

  ElectricityShortLiveDataModels({
    required this.power,
  ...
  factory ElectricityShortLiveDataModels.fromJson(Map<String, dynamic> json) {
    return ElectricityShortLiveDataModels(
