class ElectricityShortLTProductionVsCapacityModel {
  ...
  ElectricityShortLTProductionVsCapacityModel(
  ...
  ElectricityShortLTProductionVsCapacityModel.fromJson(Map<String, dynamic> json) {
