...
class ElectricityShortViewPageModel {
  final int id;
  ...
  factory ElectricityShortViewPageModel.fromJson(Map<String, dynamic> json) {
    ...
    try {
      return ElectricityShortViewPageModel(
        id: json['id'] as int,
