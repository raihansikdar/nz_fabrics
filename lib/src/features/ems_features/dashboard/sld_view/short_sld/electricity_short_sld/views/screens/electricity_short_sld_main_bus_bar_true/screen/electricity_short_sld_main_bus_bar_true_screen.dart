...
import '../widget/electricity_short_sld_date_widget.dart';


class ElectricityShortSLDMainBusBarTrueScreen extends StatefulWidget {
  final String busBarName;
  const ElectricityShortSLDMainBusBarTrueScreen({super.key, required this.busBarName});

  @override
  State<ElectricityShortSLDMainBusBarTrueScreen> createState() => _ElectricityShortSLDMainBusBarTrueScreenState();
}

class _ElectricityShortSLDMainBusBarTrueScreenState extends State<ElectricityShortSLDMainBusBarTrueScreen> {
