...
class WaterShortSLDFilterBusBarWidget extends StatelessWidget {

  final List<FilterBusBarEnergyCostModel> monthlyDataList;
  final Size size;
  final int dateDifference;

  const WaterShortSLDFilterBusBarWidget({super.key, required this.size, required this.dateDifference, required this.monthlyDataList});
