...
class WaterShortSLDDateWidget extends StatefulWidget {
  final String nodeName;
  const WaterShortSLDDateWidget({super.key, required this.nodeName});

  @override
  State<WaterShortSLDDateWidget> createState() => _WaterShortSLDDateWidgetState();
}

class _WaterShortSLDDateWidgetState extends State<WaterShortSLDDateWidget> {
