...
class WaterShortSLDLtProductionVsCapacityController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {


  bool _isConnected = true;
  bool _isLtProductionVsCapacityInProgress = false;
  String _errorMessage = '';
  WaterShortLTProductionVsCapacityModel  _ltProductionVsCapacityModel = WaterShortLTProductionVsCapacityModel ();

  bool get isConnected => _isConnected;
  bool get isLtProductionVsCapacityInProgress => _isLtProductionVsCapacityInProgress;
  String get errorMessage => _errorMessage;
  WaterShortLTProductionVsCapacityModel  get ltProductionVsCapacityModel => _ltProductionVsCapacityModel;
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<WaterShortSLDLtProductionVsCapacityController>()) {
      final controller = Get.find<WaterShortSLDLtProductionVsCapacityController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<WaterShortSLDLtProductionVsCapacityController>()) {
      final controller = Get.put(WaterShortSLDLtProductionVsCapacityController());
  ...
  Future<bool> fetchProductVsCapacityData() async {
    ...
    try {
      ...
      if (response.isSuccess) {
        ...
        _ltProductionVsCapacityModel = WaterShortLTProductionVsCapacityModel.fromJson(jsonData);
