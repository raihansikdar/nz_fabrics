class WaterShortLTProductionVsCapacityModel {
  ...
  WaterShortLTProductionVsCapacityModel(
  ...
  WaterShortLTProductionVsCapacityModel.fromJson(Map<String, dynamic> json) {
