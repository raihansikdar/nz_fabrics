...
class LiveAllNodePowerController extends GetxController with InternetConnectivityCheckMixin,WidgetsBindingObserver {
  ...
  void stopApiCallOnScreenChange() {
    if (Get.isRegistered<LiveAllNodePowerController>()) {
      final controller = Get.find<LiveAllNodePowerController>();
  ...
  void startApiCallOnScreenChange() {
    if (!Get.isRegistered<LiveAllNodePowerController>()) {
      final controller = Get.put(LiveAllNodePowerController());
