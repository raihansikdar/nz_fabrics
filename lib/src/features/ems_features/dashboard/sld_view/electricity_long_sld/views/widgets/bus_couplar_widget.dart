...
//     required this.shape,
//     required this.sourceType, required ValueKey<String> key,
//   });
//
//   @override
...
//         border: Border.all(color: status !=0.0 ? Colors.lightGreen : Colors.red, width: 2),
//       ),
//       child: Center(
//         child: Image.asset(
//           iconPath,
...
//   }
//
//   // Dynamically decide which icon to show based on the sensor status and shape
//   String _getIconPath() {
//     switch (shape) {
//     case "BusCoupler":
//     return status !=0.0 ? 'assets/images/Group1000007881.png' : 'assets/images/switch.png';
//     case "Loop": return status !=0.0 ? 'assets/images/SwitchOn90.png' : 'assets/images/SwitchOff90.png';
//     default:
