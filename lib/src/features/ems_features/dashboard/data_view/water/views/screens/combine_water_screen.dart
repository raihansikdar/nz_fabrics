...
class WaterCombinedScreen extends StatefulWidget {
  const WaterCombinedScreen({super.key});

  @override
  State<WaterCombinedScreen> createState() => _WaterCombinedScreenState();
}

class _WaterCombinedScreenState extends State<WaterCombinedScreen> {
