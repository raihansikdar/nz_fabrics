...
import 'package:nz_fabrics/src/features/ems_features/dashboard/summery_view/natural_gas_summary/model/power_model.dart';
...
class LoadNaturalGasController extends GetxController with InternetConnectivityCheckMixin {
  ...
  Future<void> fetchLoadNaturalGasData() async {
       ...
       // log('Water summary Body: ${response.body}');
        ...
        if (response.statusCode == 200) {
          ...
          naturalGasList = naturalGasList.where((water) {
            return water.loadCategory == 'Natural_Gas' && water.sourceType != 'Bus_Bar';
          }).toList();
