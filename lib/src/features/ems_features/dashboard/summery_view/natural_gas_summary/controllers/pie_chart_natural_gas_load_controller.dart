...
class PieChartNaturalGasLoadController extends GetxController with InternetConnectivityCheckMixin {
  ...
  Future<void> fetchPieChartData() async {
    ...
    try {
      ...
      NetworkResponse response = await NetworkCaller.getRequest(url: Urls.pieChartNaturalGasLoadUrl);
  ...
  // log(response.body.toString());
      ...
      if (response.statusCode == 200) {
        final jsonData = response.body;
         log('Pie Chart Load Natural Data : $jsonData');
