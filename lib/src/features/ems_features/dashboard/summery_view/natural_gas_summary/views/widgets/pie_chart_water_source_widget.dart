...
class PieChartNaturalGasSourceWidget extends StatefulWidget {


  const PieChartNaturalGasSourceWidget({super.key});

  @override
  State<PieChartNaturalGasSourceWidget> createState() => _PieChartNaturalGasSourceWidgetState();
}

class _PieChartNaturalGasSourceWidgetState extends State<PieChartNaturalGasSourceWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<PieChartNaturalGasSourceController>().fetchPieChartData();
    });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
       backgroundColor: AppColors.whiteTextColor,
        body: GetBuilder<PieChartNaturalGasSourceController>(
           // init: _controller,
            builder: (controller) {
